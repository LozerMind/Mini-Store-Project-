...
{
  private AtomicReference<BetterBasket> theBasket = new AtomicReference<>(); 
  ...
  public PackingModel(MiddleFactory mf)
  {
    ...
    theBasket.set( null );                  // Initial BetterBasket
  ...
  /**
   * Return the BetterBasket of products that are to be picked
   * @return the basket
   */
  ...
  public void doPacked()
  {
    ...
    try
    {
      BetterBasket basket =  theBasket.get();       // BetterBasket being packed
      if ( basket != null )                   // T
      {
