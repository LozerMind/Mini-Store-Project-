...
public class BackDoorController {
  ...
  /**
   * Remove stock interaction from view
   *
   * @param pn       The product number to remove stock from
   * @param quantity The quantity to remove
   */
  public void doRemoveStock(String pn, String quantity) {
    model.doRemoveStock(pn, quantity);
  }
}